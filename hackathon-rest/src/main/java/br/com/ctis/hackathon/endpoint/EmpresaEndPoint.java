...
public interface EmpresaEndPoint {
	...
	@Operation(description = "Lista os Empresa's cadastrados no sistema", summary = "Listar Empresa's", 
			   responses = {
	...
	@Produces("application/json")
	@Operation(description = "Recurso para cadastro de um novo Empresa no sistema", summary = "Adicionar novo Empresa", 
	   responses = {
			   @ApiResponse(responseCode = "200", content = @Content(mediaType = "application/json")),
			   @ApiResponse(responseCode = "400", description = "Bad Request"),
			   @ApiResponse(responseCode = "404", description = "Not found"),
